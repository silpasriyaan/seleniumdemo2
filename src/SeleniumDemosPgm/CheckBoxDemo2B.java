package SeleniumDemosPgm;//2 x-paths ichaam dheelo after click select avatla failure case
...
public class CheckBoxDemo2B {        //checkbox find chesendhuku oka x-path and click chesendhuku oka xpath 
